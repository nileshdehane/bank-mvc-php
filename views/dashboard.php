    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            .money-time-trans-sub>div {
                font-size: 12px;
                color: rgb(122, 122, 122);
                text-align: center;
            }

            .money-time-trans-sub {
                color: white;
                position: absolute;
                right: 13px;
                margin-top: 5px;
            ...
            .chart-box-main {
                background: linear-gradient(270deg, rgba(255, 255, 255, 0.28), rgb(50, 54, 59) 52%);
                width: 100%;
                border-radius: 19px;
            ...
            .chart-back-2 {
                background-color: rgb(247, 193, 89);
                transform: rotate(14deg);
                left: 9px;
                top: -2px;
                width: 286px !important;
                height: 263px !important;
                border-radius: 40px 40px 98px 98px !important;
            }

            .chart-back-1 {
                background-color: rgb(252, 63, 77);
                transform: rotate(33deg);
                left: 12px;
                top: 4px;
                width: 286px !important;
                height: 266px !important;
                border-radius: 40px 40px 132px 98px !important;
            }
            ...
            <div class="Box-header">
                <div class="box-alert-infomation">
                    <div class="box-infomation">
                        ...
                        <div class="info-name"><?php echo $user['fullname'];?></div>
                        <div class="info-name"><a href="/bank/auth/logout">logout</a></div>
            ...
            <div class="Box-elements">
                ...
                <div class="box-element-flex">
                        ...
                        ?>
                            ...
                            <div class="box-trans-sub">
                                <?php if ($transaction['type'] === 'deposit') { ?>
                                    <img src="https://i.ibb.co/ZfWchkW/icons8-deposit-48.png" alt=""><?php } else { ?>
                                    <img src="https://i.ibb.co/hMZ0gjC/icons8-initiate-money-transfer-48.png" alt=""><?php } ?>
                    ...
                    <div class="stocks ">
                        ...
                        <div class="title-element">Deposits</div>
                        <div class="stocks-main">
                            <div class="sub-stocks">
                                <form method="POST" action="/bank/dashboard/transfer">
                        ...
                        <div class="title-element">Withdraw</div>
                        <div class="stocks-main">
                            <div class="sub-stocks">
                            <form method="POST" action="/bank/dashboard/transfer">
                            <label for="amount">Amount:</label>
                                    ...
                                    <label for="remark">Remark:</label>
                                    <input type="text" id="remark" name="remark"><br><br>
                                    <input type="hidden" id="type" name="type" value="withdrawal">
                                    <input type="submit" value="Submit">
                                </form>
                            </div>
                        </div>
